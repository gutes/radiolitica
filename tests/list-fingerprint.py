...
args = {"k": config["apikey"], "s": calc_siganture("api/list-fingerprints", config["secret"]) }

h = httplib2.Http()
resp, content = h.request("http://127.0.0.1:8081/api/list-fingerprints?%s" % urlencode(args),"GET")
